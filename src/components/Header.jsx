...
function Header() {
  ...
  return (
    <nav className={`${colors.bg.gradient} text-white shadow-lg transition-all duration-300`}>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <Link to="/" className="flex items-center space-x-2 group transform hover:scale-105 transition-transform duration-200">
            <div className={`${isDarkMode ? 'bg-green-400 text-gray-900' : 'bg-white text-green-600'} rounded-full p-2 group-hover:rotate-12 transition-transform duration-300`}>
            ...
            <div>
              ...
              <p className={`text-xs ${isDarkMode ? 'text-green-300' : 'text-green-200'}`}>Sustainable Shopping</p>
            </div>
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="hover:text-green-200 transition-all duration-200 hover:scale-110 transform">
              Home
            </Link>
            <Link to="/shop" className="hover:text-green-200 transition-all duration-200 hover:scale-110 transform">
              Shop
            </Link>
            <Link to="/cart" className="hover:text-green-200 transition-all duration-200 flex items-center relative group transform hover:scale-110">
            ...
            {token ? (
              <div className="flex items-center space-x-4">
                <Link 
                  to="/profile" 
                  className="hover:text-green-200 transition-all duration-200 flex items-center space-x-1 group transform hover:scale-110"
                >
                ...
                <span className={`${isDarkMode ? 'text-green-300' : 'text-green-200'}`}>Hi, {user?.name}</span>
                <button 
              ...
              <div className="flex items-center space-x-4">
                <Link 
                  to="/login" 
                  className="hover:text-green-200 transition-all duration-200 transform hover:scale-110"
                >
                  Login
                </Link>
                <Link 
                  to="/signup" 
                  className={`${isDarkMode ? 'bg-green-500 hover:bg-green-400 text-white' : 'bg-white text-green-600 hover:bg-green-50'} px-4 py-2 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 hover:shadow-lg`}
                >
                  Sign Up
                </Link>
              </div>
